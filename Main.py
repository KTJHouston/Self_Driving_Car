...
rgs = [RewardGate((155, 323), (236, 322)), RewardGate((154, 368), (241, 360)), RewardGate((164, 422), (248, 401)), RewardGate((190, 480), (259, 435)), RewardGate((261, 529), (289, 452)), RewardGate((324, 551), (338, 461)), RewardGate((401, 555), (398, 467)), RewardGate((474, 549), (443, 466)), RewardGate((460, 464), (568, 528)), RewardGate((449, 453), (544, 424)), RewardGate((421, 421), (494, 377)), RewardGate((376, 328), (478, 350)), RewardGate((488, 339), (455, 266)), RewardGate((506, 335), (535, 271)), RewardGate((570, 365), (599, 293)), RewardGate((641, 384), (659, 311)), RewardGate((708, 403), (710, 313)), RewardGate((790, 395), (763, 305)), RewardGate((882, 338), (790, 281)), RewardGate((792, 237), (854, 181)), RewardGate((746, 221), (786, 139)), RewardGate((672, 195), (693, 120)), RewardGate((590, 177), (608, 99)), RewardGate((506, 167), (513, 94)), RewardGate((430, 161), (436, 87)), RewardGate((357, 155), (355, 89)), RewardGate((308, 163), (281, 93)), RewardGate((268, 172), (198, 131)), RewardGate((249, 218), (167, 197)), RewardGate((237, 259), (154, 252))]
rgs[-1].flip(False)
rgs[-2].flip(False)
...
def update(dt):
    global last_keys
    driver.update(dt, keys_pressed, walls, rgs)
    last_keys = keys_pressed.copy()


def reset():
    global car, driver, rgs
    # Reset Car:
    car = Car((10, 20), (128, 128, 255), (193, 296))
    driver.set_car(car)
